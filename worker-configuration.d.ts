/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 12f4b4d8f1151f3f60604246bb5b7ba8)
...
interface __BaseEnv_Env {
	...
	LIBRARY_LOGIN_RATE_LIMIT: RateLimit;
	R2_DAILY_READ_LIMIT: "10000";
	R2_MONTHLY_READ_LIMIT: "300000";
	CACHE_TTL_SECONDS: "300";
	RATE_LIMIT_RETRY_AFTER: "60";
	R2_BUDGET_RETRY_AFTER: "60";
	UPLOAD_TOKEN: string;
	R2_BUDGET: DurableObjectNamespace<import("./src/worker").R2Budget>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "R2Budget";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "R2_DAILY_READ_LIMIT" | "R2_MONTHLY_READ_LIMIT" | "CACHE_TTL_SECONDS" | "RATE_LIMIT_RETRY_AFTER" | "R2_BUDGET_RETRY_AFTER" | "UPLOAD_TOKEN">> {}
}
